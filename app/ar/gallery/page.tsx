      ...
      >
        <div className="container mx-auto px-4">
          <div className="text-center">
            <h2 className="text-4xl font-bold text-white mb-4">المعرض</h2>
            <nav className="text-white" dir="rtl">
              <a href="/ar" className="hover:text-[#b0b435]">
                الرئيسية
              </a>
              <span className="mx-2">/</span>
              <span className="text-[#b0b435]">المعرض</span>
            </nav>
          </div>
        </div>
      </div>
      ...
      <div className="py-16 bg-gray-50" dir="rtl">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h1 className="text-3xl font-bold text-gray-800 mb-2">معرضنا</h1>
