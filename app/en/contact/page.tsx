        ...
        <div className="container mx-auto px-4">
          <div className="text-center">
            ...
            <nav className="text-white">
              ...
              <span className="text-[#b0b435]">Contact Us</span>
            </nav>
          </div>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="bg-gray-50 p-8 rounded-lg">
              ...
              <p className="text-gray-600 mb-6">
                If you are interested in the services of EL SAFWA or have any
                inquiries about our products or projects, we welcome your
                communication. We believe in the importance of effective
                communication with our clients to meet their needs and provide
                the best solutions.
              </p>
